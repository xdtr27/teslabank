...
export default function Benefits() {
  return (
    <section className="p-mobile md:p-desktop py-24 md:py-40 mt-20 bg-rose-50 ">
      ...
      <div className="flex flex-col gap-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-7">
          ...
          <Card
            title="Investimentos"
            icon={ShoppingCart}
            buttonText="Conheça os investimentos"
          >
          ...
          <Card
            title="Segurança"
            icon={Shield}
            buttonText="Conheça as seguranças"
          >
